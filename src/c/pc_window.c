...
switch (cell_index->section) {
    ...
    case 0:
      ...
      switch (cell_index->row) {
        ...
        case 0:
          menu_cell_basic_draw(ctx, cell_layer, "Open Explorer" , NULL , NULL);
          break;

        case 1:    
          menu_cell_basic_draw(ctx, cell_layer, "Run",  NULL , NULL );
          break;
          
        case 2:
          menu_cell_basic_draw(ctx, cell_layer, "Minimize All",  NULL , NULL);
          break;
      }
      break;   
    break;
    ...
    switch (cell_index->section) {
        ...
        case 0:
              ...
              switch (cell_index->row) {
	            ...
	            case 0:
                    //APP_LOG(APP_LOG_LEVEL_DEBUG, "open explorer clicked.");
                    send_message1(WINDOW_OPEN);
	  	        break;
	 
                case 1:
                    //APP_LOG(APP_LOG_LEVEL_DEBUG, "run clicked.");
                    send_message1(WINDOW_RUN);
                break;
	  
	            case 2:
                     //APP_LOG(APP_LOG_LEVEL_DEBUG, "minimized all clicked.");
                     send_message1(WINDOW_MINIMIZE);
	            break;
